...
def parse_arguments():
    ...
    parser.add_argument('--content_dir',type=str,default=r"D:\Kaggle_GPU_NST\content_data",
                        help="Location of content dataset")
    
    parser.add_argument('--style_dir',type=str,default=r"D:\Kaggle_GPU_NST\style_data",
    ...
    for epoch in range(args.start_epoch,args.epochs):
        ...
        if (epoch+1) % args.save_interval == 0:
            ...
            torch.save(
                ...
                save_dir / f'scheduler_{epoch+1}.pth'
            )
